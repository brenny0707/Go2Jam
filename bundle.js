...
var gdEasy0 = [1650, 5500, 10710, 11140, 18110, 21280, 21780, 23780, 29940, 31840, 36500];

var gdEasy1 = [6610, 7620, 8600, 10160, 11630, 13110, 18470, 20760, 22820, 24860, 25780, 26360, 27700, 28370, 28870, 29450, 30920, 32990, 33850, 34500, 35820];

var gdEasy2 = [6610, 9590, 12120, 13630, 14190, 14660, 15190, 18970, 20250, 22820, 24340, 25780, 27700, 28870, 30920, 32440, 33850, 37560];

var gdEasy3 = [5500, 9050, 15480, 16730, 19690, 21780, 29940];
  ...
  _createClass(Game, [{
    ...
    value: function openModal(modalId) {
      ...
      if (modalId === 'score-modal') {
        ...
        var textnode = document.createTextNode('Final Score: ' + this.beatMap.score);
